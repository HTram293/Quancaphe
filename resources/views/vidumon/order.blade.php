<x-product-layout>
                ...
                <tbody>
                    ...
                    @foreach($data as $key=>$row)
                       <tr>
                            ...
                            <td align='center'>{{number_format($row->price,0,',','.')}}đ</td>
                            <td align='center'>
                       ...
                       @php
                            $tongTien +=$quantity[$row->id]*$row->price;
                        @endphp
                    @endforeach
                    <tr>
    ...
    <div class="bg-gray-100 p-4 rounded mb-4">
        <h2 class="text-lg font-semibold mb-2">Thông tin đặt bàn</h2>
        <p><strong>Loại bàn:</strong> {{ $bookingData['type'] }}</p>
        <p><strong>Số bàn:</strong> {{ $bookingData['table'] }}</p>
        <p><strong>Số ghế:</strong> {{ $bookingData['seats'] }}</p>
    </div>
@endif
