...
<a class="nav-link menu-loai-mon" href="#" loai_mon="">Trang chủ</a>
</li>
<li class="nav-item">
<a class="nav-link menu-loai-mon" href="#" loai_mon="1">Cà phê</a>
</li>
<li class="nav-item">
<a class="nav-link menu-loai-mon" href="#" loai_mon="2">Trà sữa</a>
</li>
<li class="nav-item">
<a class="nav-link menu-loai-mon" href="#" loai_mon="3">Nước ép</a>
</li>
<li class="nav-item">
<a class="nav-link menu-loai-mon" href="#" loai_mon="4">Sinh tố</a>
</li>
<li class="nav-item">
<a class="nav-link menu-loai-mon" href="#" loai_mon="5">Trà</a>
</li>
</ul>
</nav>
</div>
