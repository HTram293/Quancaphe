...
Route::get('/table', 'App\Http\Controllers\CapheController@tableList')->name('table.main');
Route::post('/table/submit', 'App\Http\Controllers\CapheController@submitTable')->name('table.submit');